...
public class ManageSuppliers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(888, 510));

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.setToolTipText("Go To ");
        jPanel1.setMaximumSize(new java.awt.Dimension(888, 510));
        jPanel1.setPreferredSize(new java.awt.Dimension(888, 510));
...
//            control.addSupplier(name, telephone, address, gender, email, orders);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        String search = jTextField1.getText();
        model.setRowCount(0);
        String sql = "SELECT * FROM supplier WHERE name LIKE '%" + search + "%'";
        try {
            ...
            while (resultSet.next()) {
                ...
                model.addRow(new Object[]{ID, name, telephone, address, gender, email});
            }
        } catch (Exception e) {
        }
